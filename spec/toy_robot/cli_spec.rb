 ...
 RSpec.describe ToyRobot::CLI do
   ...
   context "run" do
      ...
      context "turn right command" do
        it "passes a turn right command to the simulator" do
      ...
      context "turn left command" do
        it "passes a turn left command to the simulator" do
          expect(simulator).to receive(:turn_left)
          subject.run([[:turn_left]])
        end
      end
      context "turn report command" do
        it "passes a turn report command to the simulator" do
